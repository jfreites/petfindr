...
@section('content')
    <div class="container col-xxl-8 px-4 py-5">
        <div class="row">
            <form id="signUpForm" action="{{ route('pet.report.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <!-- start step indicators -->
                <div class="form-header d-flex mb-4">
                    <span class="stepIndicator">Cuéntanos de tu mascota</span>
                ...
                <!-- step one -->
                <div class="step">
                    <p class="text-center mb-4">Cuéntanos de tu mascota</p>
                    <div class="mb-3">
                        <input type="email" placeholder="Nombre o Apodo" oninput="this.className = ''" name="name">
                    </div>
                    <div class="mb-3">
                        <input type="text" placeholder="Descríbela" oninput="this.className = ''" name="description">
                    </div>
                    <div class="mb-3">
                        <input type="text" placeholder="Su última ubicación conocida" oninput="this.className = ''"
                            name="last_location">
                    </div>
                </div>
